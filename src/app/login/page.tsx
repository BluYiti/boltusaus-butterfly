            ...
            <div className="flex bg-white rounded-lg shadow-lg max-w-4xl w-full">
                ...
                <div className="w-1/2 flex flex-col items-center justify-center bg-blue-50 p-8">
                    <div className="flex flex-col items-center">
                        ...
                        <img src="/images/ButterflyLanding.png" alt="A.M.Peralta Psychological Services" className="h-24 w-24 mb-4"/>
                    </div>
                    <h2 className="text-xl font-semibold text-center">A.M.Peralta Psychological Services</h2>
                </div>
