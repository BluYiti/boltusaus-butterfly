    ...
    return (
        <div className='overflow-hidden flex flex-col items-center min-h-screen'>
            ...
            <div className="flex justify-center items-center mt-10">
                ...
                <div className="ml-10 ">
                    <AdultRegisterForm onRegister={function (data: { firstName: string; lastName: string; birthday: string; address: string; contactNumber: string; idFile: File | null; email: string; password: string; }): void {
