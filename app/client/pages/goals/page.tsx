...
const GoalsPage = () => {
    ...
    const [mood, setMood] = useState<Goal['mood'] | ''>(''); // Mood can either be empty or one of the moods in Goal type
    ...
    const [goals, setGoals] = useState<Goal[]>([]); // Define goals as an array of Goal type
                                ...
                                return (
                                    <button
                                        ...
                                        className={`py-2 px-4 rounded-lg mt-2 transition-colors duration-300 shadow-md ${
                                            isSelected ? selectedMoodColors[moodLabel] : moodColors[moodLabel]
                                        }`}
                                    >
