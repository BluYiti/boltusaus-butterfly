...
const LoginPage: React.FC = () => {
    ...
    return (
        <div className='overflow-hidden'>
            ...
            <div
            className="absolute right-14 w-1/2 h-screen bg-cover bg-no-repeat hidden md:block"
            style={{ backgroundImage: `url('/images/adultfly.png')` }}
            ></div>
            <div
            className="absolute right-0 w-14 h-screen bg-cover bg-no-repeat hidden md:block"
            style={{ backgroundImage: `url('/images/rightblock.png')` }}
            ></div>
        </div>
    );
};
